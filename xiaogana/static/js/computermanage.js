// app.controller('computermanageCtrl', function($scope,$http,$filter,$state,$rootScope) {
...
//             $state.go('computermanage.particulars');//显示详情
//             $rootScope.condition="off";
//         }else{
//             $state.go('computermanage.enteringone');//默认显示设备管理
//         }
//     }
// });
