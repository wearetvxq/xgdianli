app.controller('towerCtrl', function ($scope, $http, $filter, $state, $rootScope) {
    console.log("towerCtrl");
    ...
    $scope.boxx=function(){
        ...
        $("#boxx").css("overflow", "auto");
    }
    $scope.boxxleave=function(){
        //$("#dutyControl").css("overflow-x", "auto");
