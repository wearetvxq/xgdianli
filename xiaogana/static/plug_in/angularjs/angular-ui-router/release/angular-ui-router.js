 ...
 *
 * A [[ParamTypeDefinition]] is a plain javascript object used to register app parameter types.
...
var ParamType = (function () {
    /**
     * @param def  A configuration object which contains the app type definition.  The object's
    ...
    /**
     * Wraps an existing app ParamType as an array of ParamType, depending on 'mode'.
     * e.g.:
 ...
 *
 * This registry manages the built-in (and app) parameter types.
 *
...
var UrlMatcherFactory = (function () {
    ...
    /**
     * Creates and registers a app [[ParamType]] object
     *
     ...
     *
     * Note: Register app types *before using them* in a state definition.
     *
 ...
 * Plugins can define app hook types, such as sticky states does for `onInactive`.
 *
 * @interalapi
 */
 ...
 *
 * Include this object when applying app defaults:
...
var StateService = (function () {
     ...
     *
     * You can provide your own app handler.
     *
     * #### Example:
     * ```js
...
var StateProvider = (function () {
     ...
     * This can be used to add app functionality to ui-router,
     ...
     *
     * In addition, users can attach app decorators, which will generate new
