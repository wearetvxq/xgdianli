         ...
         <transition name="move">
           <div class="content" v-show="mainarea">
              ...
              <div class="content-footer">
                  <Button @skip="aircondition"></Button>
              </div>
         </div>
         </transition>
     </div>
     ...
     methods:{
      ...
      //  提交
       aircondition(){
          ...
          formData.append("type2",this.Data.type2);
          ...
          if(this.Data.area&&this.Data.name&&this.Data.code&&this.Data.type&&this.Data.produce&&
            this.Data.number&&this.Data.gong&&this.Data.type2&&this.Data.c&&this.Data.desc&&
            this.Data.pic&&this.Data.dianbiao_id){
