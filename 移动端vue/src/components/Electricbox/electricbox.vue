     ...
     <div class="switch">
         <transition name="move">
              ...
              <div class="content-footer">
                  <Button @skip="electricbox" ></Button>
              </div>
         </div>
         </transition>
     </div>
     ...
     methods:{
      ...
      //  提交
       electricbox(){
          ...
          if(this.Data.area&&this.Data.name&&this.Data.code&&this.Data.type&&this.Data.produce&&
            this.Data.number&&this.Data.cap&&this.Data.c&&this.Data.desc&&this.Data.pic&&
            this.Data.dianbiao_id){
      ...
      countProportion(){
        if(this.last&&this.now){
          this.percentage=this.last/this.now;
        }else{
